package com.lojaconstrucao.web.exception;
...
import com.lojaconstrucao.web.response.Fields;
import com.lojaconstrucao.web.response.SystemErrorMessage;
...
public class SystemExceptionHandler {
	...
	public ResponseEntity<?> methodArgumentNotValidException(MethodArgumentNotValidException except, WebRequest request){
		...
		BindingResult bindingResult = except.getBindingResult();
